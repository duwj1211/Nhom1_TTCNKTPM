                ...
                <div className={cx("row gy-4")}>
                    <div className={cx("col-12 col-md-7")}>
                        ...
                        <form className={cx("billing-details")}>
                            <div className={cx("fn")}>
                                <label htmlFor="firstname" className="form-label">Họ tên người nhận<span className={cx("required")}>*</span></label>
                                <input 
                                    className={cx("first-name","form-control")} id="firstname"
                                    type='text'
                                    name='fullName'
                            ...
                            <div className={cx("phone-number")}>
                                ...
                                <input 
                                    className={cx("phone-num","form-control")} placeholder="+84xxxxxxxxx"
                                    type='text'
                                    name='phoneNumber'
                            ...
                            <div className={cx("street-address")}>
                                ...
                                <input 
                                    className={cx("street-add","form-control")} placeholder="Số nhà hoặc tên đường"
                                    type='text'
                                    name='detailAddress'
                            ...
                            <div className={cx("inside-order-payment")}>
                                ...
                                <div className={cx("order-container")}>
                                    ...
                                    <div className={cx("order")}>
                                        <button onClick={handleSubmit} type='button' className={cx("btn", "btn-outline-custom")}>Tiến hành thanh toán</button>
                                    </div>
                                </div>
                            </div>   
                        </div>
