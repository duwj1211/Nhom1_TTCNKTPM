                                    ...
                                    <div className={cx('grid')}>
                                        <div className={cx('book-info')}>
                                            ...
                                            <div className={cx('cart')}>
                                                <input className={cx('quantity')} type='number' id='quantity'  aria-label='Product quantity' size='4' min='1' max='' step='1' value={quantity} placeholder='' inputMode='numeric' autoComplete='on' onChange={handleChange}></input>
